...
/* Queries */
export const getCurrentUserProfilePictureUploadUrl = currentUserWrapper(async ({ userId, fileExtension }: { userId: string, fileExtension: string | null }) => {
  ...
  return {
    ...
    storageUrl: process.env.NEXT_PUBLIC_SUPABASE_URL + '/storage/v1/object/public/' + bucket + '/' + path,
  }
})
