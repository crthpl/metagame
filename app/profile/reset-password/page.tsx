...
type PasswordResetErrors = Partial<Record<keyof z.infer<typeof passwordResetSchema>, string | string[]>> & {
  submit?: string
}
      ...
      <div className="bg-dark-400 p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col">
            <label htmlFor="password" className="mb-1 font-medium flex gap-1 items-center">
              <LockIcon className="size-4" /> New Password: <span className="text-red-500">*</span>
            </label>
            <input 
              id="password" 
              name="password" 
          ...
          <div className="flex flex-col">
            <label htmlFor="confirmPassword" className="mb-1 font-medium flex gap-1 items-center">
              <LockIcon className="size-4" /> Confirm Password: <span className="text-red-500">*</span>
            </label>
            <input 
              id="confirmPassword" 
